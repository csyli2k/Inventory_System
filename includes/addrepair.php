...
//add repair
      ...
      $result=add_repair_query_y($conn,$vin, $labor_charge, $description, $odometer_reading, $customerID, $username);
      if ($result) {
        echo "Record updated successfully";
        echo '<p><a href="../repair_search.php" title="To add repair page">Go Back To Repair Search</a></p>';
      } else {
