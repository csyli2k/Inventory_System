...
//add parts
      ...
      $result=add_parts_query_y($conn,$vin,$vendorname,$partnumber,$quantity,$price);


      if ($result) {
        echo "Record updated successfully";
        echo '<p><a href="../repair_search.php" title="Return to parts page">Go Back To Repair Search</a></p>';
