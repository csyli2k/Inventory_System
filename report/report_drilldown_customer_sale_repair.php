...
$page_name = 'Customer Income Drill Down';
...
<body>
    ...
    if (!isset($_GET["customer_id"])) {
        echo "<h1> no customer_id is set </h1>";
        die("no customer set");
    }
    ...
    <div>
        ...
        <table class="report_table">
            ...
            $result = query_sale_records_of_customer($conn, $customer_id);
    ...
    <div>
        <h2 class="report_text">Repair Drill Down</h2>
        <table class="report_table">
            <?php
            $conn = mysql_conn_init_6400();
            $result = query_repair_records_of_customer($conn, $customer_id);
            if ($result->num_rows == 0) {
                echo "<h4> no records found</h4>";
            } else {
                $is_header_printed = false;
